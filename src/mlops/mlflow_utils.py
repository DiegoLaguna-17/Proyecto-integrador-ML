...
def setup_mlflow(config):
    """
    Configura el tracking de MLflow usando SQLite como backend
    (compatible con versiones modernas de MLflow que deprecaron el file-store).
    """
    # Usar la DB SQLite que ya existe en el proyecto
    db_path = os.path.abspath("mlflow_local.db")
    tracking_uri = f"sqlite:///{db_path}"
    
    # Asegurar que el directorio de artefactos exista
...
def log_run_metrics(y_true, y_pred, class_names, dataset_version, parameters, config_dict, stage_name, model, model_type="sklearn"):
    """
    Loguea parámetros, métricas, matriz de confusión y el reporte de clasificación a MLflow.
    """
    ...
    # Registrar toda la configuración en formato json
    ...
    # Determinar etiquetas según el tipo de datos de y_true
    ...
    # 4. Generar y registrar Reporte de Clasificación en archivo de texto
    ...
    # 5. Generar y registrar Matriz de Confusión como imagen
    ...
    if model_type == "sklearn":
        ...
        # Se requiere loguear el modelo Keras
